...
const menuAPIServer = require('../bin/www.js');
    ...
    context('When the GET menu endpoint is invoked', function() {
        ...
        return request.get('/menu')
            ...
            .then(function(res) {
                ...
                pokemons.should.all.have.property('label');
                pokemons.should.all.have.property('url');
                pokemons.should.all.have.property('items');
                done();
            });
        });
    });
